...
public class Pelanggan {
    ...
    // ===== OVERRIDE #1 =====
    // Di-override oleh PelangganBiasa dan PelangganVIP
    ...
    // Baris ringkas untuk tabel — di-override PelangganBiasa & PelangganVIP
    public void tampilkanRingkas(int nomor) {
        System.out.printf("  %-4d  %-20s%n", nomor, nama);
    }

    // ===== OVERRIDE #2 =====
    // Di-override PelangganBiasa (tanpa diskon) & PelangganVIP (dengan diskon)
